...
function keyPressed() {
   ...
   //handleCollision();
    if (keyCode == RIGHT_ARROW) {
        theplayer.setSpeed(2, 0);
    }
    else if (keyCode == DOWN_ARROW) {
        theplayer.setSpeed(2, 90);

    }
    else if (keyCode == LEFT_ARROW) {
        theplayer.setSpeed(2, 180);

    }
    else if (keyCode == UP_ARROW) {
        theplayer.setSpeed(2, 270);
