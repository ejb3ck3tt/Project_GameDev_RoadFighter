...
let y = 0;
let destX = 0; // x and y destination of player
let destY = 0;
...
//let xSize = 900; //window width
//let ySize = 600; //window width
...
//                   enemyY[e] += enemyTY[e];
//                   enemyY[i].bounce(player1[d]);
//                     
//                    console.log(enemyY[6]);
//                }
//            }
            
            for(let e = 0; e < enemyY.length; e++) {
                
                image(enemy[e], enemyX[e], enemyY[e] + a); 
                    enemyY[e] += enemyTY[e];
                     a = a - 0.5;
                    if(a < 0) {
                        a = height;         
